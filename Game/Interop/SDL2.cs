...
namespace Bare.Interop
{
	...
	public static class SDL2
	{
		...
		/// </summary>
        private const string libSDL2 = "SDL2.dll";
		...
		[DllImport(libSDL2, EntryPoint = "SDL_RWFromFile", CallingConvention = CallingConvention.Cdecl)]
        ...
        */
		...
		/// <returns></returns>
		[DllImport(libSDL2, EntryPoint = "SDL_ShowMessageBox", CallingConvention = CallingConvention.Cdecl)]
		...
		/* SDL_GLattr used with SDL_GL_SetAttribute attr */
		public const uint SDL_GL_RED_SIZE = 0;
		public const uint SDL_GL_GREEN_SIZE = SDL_GL_RED_SIZE + 1;
		public const uint SDL_GL_BLUE_SIZE = SDL_GL_GREEN_SIZE + 1;
		public const uint SDL_GL_ALPHA_SIZE = SDL_GL_BLUE_SIZE + 1;
		public const uint SDL_GL_BUFFER_SIZE = SDL_GL_ALPHA_SIZE + 1;
		public const uint SDL_GL_DOUBLEBUFFER = SDL_GL_BUFFER_SIZE + 1;
		public const uint SDL_GL_DEPTH_SIZE = SDL_GL_DOUBLEBUFFER + 1;
		public const uint SDL_GL_STENCIL_SIZE = SDL_GL_DEPTH_SIZE + 1;
		public const uint SDL_GL_ACCUM_RED_SIZE = SDL_GL_STENCIL_SIZE + 1;
		public const uint SDL_GL_ACCUM_GREEN_SIZE = SDL_GL_ACCUM_RED_SIZE + 1;
		public const uint SDL_GL_ACCUM_BLUE_SIZE = SDL_GL_ACCUM_GREEN_SIZE + 1;
		public const uint SDL_GL_ACCUM_ALPHA_SIZE = SDL_GL_ACCUM_BLUE_SIZE + 1;
		public const uint SDL_GL_STEREO = SDL_GL_ACCUM_ALPHA_SIZE + 1;
		public const uint SDL_GL_MULTISAMPLEBUFFERS = SDL_GL_STEREO + 1;
		public const uint SDL_GL_MULTISAMPLESAMPLES = SDL_GL_MULTISAMPLEBUFFERS + 1;
		public const uint SDL_GL_ACCELERATED_VISUAL = SDL_GL_MULTISAMPLESAMPLES + 1;
		public const uint SDL_GL_RETAINED_BACKING = SDL_GL_ACCELERATED_VISUAL + 1;
		public const uint SDL_GL_CONTEXT_MAJOR_VERSION = SDL_GL_RETAINED_BACKING + 1;
		public const uint SDL_GL_CONTEXT_MINOR_VERSION = SDL_GL_CONTEXT_MAJOR_VERSION + 1;
		public const uint SDL_GL_CONTEXT_EGL = SDL_GL_CONTEXT_MINOR_VERSION + 1;
		public const uint SDL_GL_CONTEXT_FLAGS = SDL_GL_CONTEXT_EGL + 1;
		public const uint SDL_GL_CONTEXT_PROFILE_MASK = SDL_GL_CONTEXT_FLAGS + 1;
		public const uint SDL_GL_SHARE_WITH_CURRENT_CONTEXT = SDL_GL_CONTEXT_PROFILE_MASK + 1;
		public const uint SDL_GL_CONTEXT_RELEASE_BEHAVIOR = SDL_GL_SHARE_WITH_CURRENT_CONTEXT + 1;

		/* SDL_GLprofile values used with SDL_GL_SetAttribute SDL_GL_CONTEXT_PROFILE_MASK */
		...
		/* SDL_GLcontext values used with SDL_GL_SetAttribute SDL_GL_CONTEXT_FLAGS */
		...
		public const byte SDL_WINDOWEVENT_SHOWN = SDL_WINDOWEVENT_NONE + 1;
		public const byte SDL_WINDOWEVENT_HIDDEN = SDL_WINDOWEVENT_SHOWN + 1;
		public const byte SDL_WINDOWEVENT_EXPOSED = SDL_WINDOWEVENT_HIDDEN + 1;
		public const byte SDL_WINDOWEVENT_MOVED = SDL_WINDOWEVENT_EXPOSED + 1;
		public const byte SDL_WINDOWEVENT_RESIZED = SDL_WINDOWEVENT_MOVED + 1;
		public const byte SDL_WINDOWEVENT_SIZE_CHANGED = SDL_WINDOWEVENT_RESIZED + 1;
		public const byte SDL_WINDOWEVENT_MINIMIZED = SDL_WINDOWEVENT_SIZE_CHANGED + 1;
		public const byte SDL_WINDOWEVENT_MAXIMIZED = SDL_WINDOWEVENT_MINIMIZED + 1;
		public const byte SDL_WINDOWEVENT_RESTORED = SDL_WINDOWEVENT_MAXIMIZED + 1;
		public const byte SDL_WINDOWEVENT_ENTER = SDL_WINDOWEVENT_RESTORED + 1;
		public const byte SDL_WINDOWEVENT_LEAVE = SDL_WINDOWEVENT_ENTER + 1;
		public const byte SDL_WINDOWEVENT_FOCUS_GAINED = SDL_WINDOWEVENT_LEAVE + 1;
		public const byte SDL_WINDOWEVENT_FOCUS_LOST = SDL_WINDOWEVENT_FOCUS_GAINED + 1;
		public const byte SDL_WINDOWEVENT_CLOSE = SDL_WINDOWEVENT_FOCUS_LOST + 1;
		/* Available in 2.0.5 or higher */
		public const byte SDL_WINDOWEVENT_TAKE_FOCUS = SDL_WINDOWEVENT_CLOSE + 1;
		public const byte SDL_WINDOWEVENT_HIT_TEST = SDL_WINDOWEVENT_TAKE_FOCUS + 1;

		/* SDL_WindowFlags used with SDL_CreateWindow flags */
		...
		public const uint SDL_WINDOW_MOUSE_CAPTURE = 0x00004000;
		...
		/// <param name="flags">0, or one or more flags OR'd together;
		...
		/// <returns>Returns the window that was created or NULL on failure;
		/// call <see cref="SDL_GetError()"/> for more information. </returns>
		[DllImport(libSDL2, CallingConvention = CallingConvention.Cdecl)]
		...
		/// </summary>
		/// <param name="window">the window to query</param>
		/// <returns>Returns a mask of the flags associated with window; see Remarks for details.</returns>
		[DllImport(libSDL2, CallingConvention = CallingConvention.Cdecl)]
		...
		/// <returns>Returns the window associated with id or NULL if it doesn't exist
		/// call <see cref="SDL_GetError()"/> for more information. </returns>
		[DllImport(libSDL2, CallingConvention = CallingConvention.Cdecl)]
		...
		[DllImport(libSDL2, EntryPoint = "SDL_UpperBlit", CallingConvention = CallingConvention.Cdecl)]
		...
		/* src and dst refer to an SDL_Surface* */
		[DllImport(libSDL2, EntryPoint = "SDL_UpperBlitScaled", CallingConvention = CallingConvention.Cdecl)]
		...
		[DllImport(libSDL2, EntryPoint = "SDL_LoadBMP_RW", CallingConvention = CallingConvention.Cdecl)]
		...
		/* IntPtr refers to an SDL_Surface* */
		/* THIS IS AN RWops FUNCTION! */
		[DllImport(libSDL2, EntryPoint = "SDL_SaveBMP_RW", CallingConvention = CallingConvention.Cdecl)]
...
#pragma warning restore 0169
		...
		/* THIS IS AN RWops FUNCTION! */
		[DllImport(libSDL2, EntryPoint = "SDL_GameControllerAddMappingsFromRW", CallingConvention = CallingConvention.Cdecl)]
		...
		/* THIS IS AN RWops FUNCTION! */
		[DllImport(libSDL2, EntryPoint = "SDL_LoadWAV_RW", CallingConvention = CallingConvention.Cdecl)]
	...
	internal unsafe class StringMarshaler : ICustomMarshaler
	{
		...
		private static ICustomMarshaler unmanagedInstance = new StringMarshaler(true);
		private static ICustomMarshaler managedInstance = new StringMarshaler(false);
		...
		public StringMarshaler(bool unmanaged)
		{
		...
		public object MarshalNativeToManaged(IntPtr data)
		{
			...
			while (*p != 0)
				p++;
			var bytes = new byte[p - (byte*)data];
		...
		public IntPtr MarshalManagedToNative(object obj)
		{
			...
			var s = obj as string;
			if (s == null)
				throw new ArgumentException("obj must be a string.", nameof(obj));
			var bytes = Encoding.UTF8.GetBytes(s);
			var data = SDL2.SDL_malloc((IntPtr)(bytes.Length + 1));
